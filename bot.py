...
async def echo(client, message):
 ...
 keybord1= InlineKeyboardMarkup( [
	...
	[InlineKeyboardButton(" Keyingi --->",callback_data = "page2")
	]
	] )
...
async def translate_text(bot,update):
  keybord6 =  InlineKeyboardMarkup([
       ...
       [InlineKeyboardButton("<--- Oldingi",callback_data = "page5")
  ...
  keybord5 = InlineKeyboardMarkup([
         ...
         [InlineKeyboardButton("<--- Oldingi",callback_data = "page4"),
         InlineKeyboardButton("Keyingi --->",callback_data = "page6")
         ]  ])
  ...
  keybord4 = InlineKeyboardMarkup([
          ...
          [InlineKeyboardButton("<--- Oldingi",callback_data = "page3"),
          InlineKeyboardButton("Keyingi --->",callback_data = "page5")
          ]
  ...
  keybord2= InlineKeyboardMarkup([
           ...
           [InlineKeyboardButton("<--- Oldingi",callback_data = "page1"),
           InlineKeyboardButton(" Keyingi --->",callback_data = "page3"),
           ]
            ])
